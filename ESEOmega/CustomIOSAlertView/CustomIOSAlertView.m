...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[UINavigationBar appearance].barTintColor forState:UIControlStateNormal];
        [closeButton setTitleColor:[UINavigationBar appearance].barTintColor forState:UIControlStateHighlighted];
